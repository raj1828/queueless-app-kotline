...
import com.example.queueless.ui.homescreen.mapper.toServiceItem
...
//    )
    ...
    val businesses by viewModel.listOfBusinesses.collectAsState()

    // Fetch data once
    LaunchedEffect(Unit) {
        Log.d("Runnn", "Runnnnnnnnnnnnnnn")
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(businesses) { business ->
                ServiceCard(
                    service = business.toServiceItem(),
                    onClick = {
